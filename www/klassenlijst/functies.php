...
// Dit blok NIET aanpassen:
        ...
        $gemiddeldeOpbrengst = $medewerker['opbrengst'] / $medewerker['gewerkte_dagen'];
        //
...
<p>Gemiddelde dagopbrengst: &euro;<?php echo round($gemiddeldeOpbrengst, 2) ?></p>
<hr />

<!-- Maak hier opdracht 5.3 (tussen de foreach): -->
<?php foreach($autos as $auto): ?>
    <p><?php echo $auto['merk']. ", ". $auto['teller']; ?>km</p>
...
<div class="persoon">
    <img src="<?php echo $medewerker['foto']; ?>" alt="foto mederwerker">
    <strong><?php echo ucfirst($medewerker['voornaam'])." ".ucfirst($medewerker['achternaam']); ?></strong>
    <i><?php echo strtoupper($medewerker['bedrijf']); ?></i>
